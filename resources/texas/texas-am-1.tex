...
\graphicspath{{/Users/will/Dropbox/}} %% add an extra path if you've moved the X in X/pictures/ someplace

%% todo: tidy topic model sequence, sum up, lab: installation of java on Windows link, documentise notes


\talktitle{Winter Institute:\\Computer-Assisted Content Analysis}
\author{\textbf{Will Lowe}\\University of Mannheim}

\date{}
\runningfooter{Texas A\&M, January 2015}

\begin{document}

\maketitle

\slide{Practicalities: Materials}
...
\slide{The Transcendental Question}
~\\
...
\slide{Dealing with Difficult Words}
...
\slide{Statistical Models of Words: Poisson}
...
\slide{Statistical Models of Words: Multinomial}
...
\slide{We build measurement devices}

\centerline{\includegraphics[scale=.2]{pictures/geiger_counter}}

\slide{(Almost) the big picture}

\centerline{\includegraphics[scale=.5]{pictures/tad-picture}}

\slide{Really the big picture}
...
\slide{Absence is an observation}
...
\slide{Theory measurement separation}
...
\slide{Classical content analysis}
...
\slide{Content Analysis Dictionary}
...
\slide{\ldots from a underspecified likelihood: P(W | Z)}
...
\slide{\ldots leading to a posterior over content}
...
\slide{Connecting CCA content to politics}
...
\slide{Ratios: How 'New' was New Labour?}
...
%
\slide{Interpreting Risk Ratios}
...
\slide{Extensions: Regularised log odds}
...
\slide{\ldots as dependent variable}
...
\slide{Content as something to explain (Sullivan and Lowe 2007)}
...
\slide{OK, how do I make such an instrument?}
...
\slide{In Action (Laver and Garry 2000)}

\centerline{\includegraphics[scale=.7]{pictures/lg-shrinkage}}
 
 
\slide{In Action (Mikhaylov et al. 2012)}
...
\slide{Solutions: Try to Avoid it}
...
\slide{Recovering from Measurement Error: Model it (1)}
...
\slide{Recovering from Measurement Error: Model It (2)}
...
\slide{Topic Models as Classical Content Analysis}
...
\slide{Generative probability model}
...
\slide{Topic Models: How \textit{many} topics?}
