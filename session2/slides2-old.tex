...
\graphicspath{{../../../}} %% add an extra path if you've moved the X in X/pictures/ someplace
...
\slide{Automated Data Collection: Web Scraping with R}


\begin{center}\includegraphics[scale=3.1,angle=0]{pictures/automateddata.jpg}
\end{center}
...
\centerline{\includegraphics[scale=1.24]{pictures/grimmerovreview.pdf}}
...
\centerline{\includegraphics[scale=2]{pictures/evans1.pdf}}
...
\slide{Example of Naive Bayes Classifier: Amicus Curiae Briefs}
...
\centerline{\includegraphics[scale=.2]{pictures/fightin0}}
...
\centerline{\includegraphics[scale=.21]{pictures/fightin2}}
...
%%
%%\centerline{\includegraphics[scale=.5]{pictures/911}}
%
...
%\newpage
%
%%\centerline{\includegraphics[scale=.58]{pictures/topic-clustering}}
%%
%%{\footnotesize (Quinn et al. 2010)}
%%%\newpage
%%
%%%\centerline{\includegraphics[scale=.7]{pictures/other-schemes}}
%%
...
%%\slide{Readme vs SVM}
%%
%%\centerline{\includegraphics[scale=.85]{pictures/affect-blogs}}
%%
...
\slide{Designing a Content Analysis:\\Issue to Consider}
...
\slide{Constructing Dictionaries}
