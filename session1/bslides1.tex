...
\centerline{\includegraphics[scale=0.15]{milgram-subject}}
...
\includegraphics[scale=2]{etinarcadiaego}
...
\begin{center}
\includegraphics[scale=.9]{gen-plate}
\end{center}
...
\begin{center}
\includegraphics[scale=.9]{inf-plate}
\end{center}
...
\begin{center}
\includegraphics[scale=1.2]{obamawordle}
\end{center}
...
\begin{center}
\includegraphics[scale=1.2]{zipfy}
\end{center}
...
\centerline{\includegraphics[scale=.2]{geiger_counter}}
...
\centerline{\includegraphics[scale=1]{20-sided-die}}
...
\centerline{\includegraphics[scale=.5]{tad-picture}}

\end{frame}
\begin{frame}[t,fragile]\frametitle{Really the big picture}

\centerline{\includegraphics[scale=.45]{measurement-validity}}
...
\centerline{\includegraphics[scale=.12]{distant-reading}}
...
\centerline{\includegraphics[scale=.8]{gamson-modigliani-frames-opinion}}
...
\centerline{\includegraphics[scale=.7]{kerry-blogs}}
...
\begin{center}
\includegraphics[scale=.7]{binladen}
\end{center}

\end{frame}
\begin{frame}[t,fragile]\frametitle{Talking Like the Commission}

\centerline{\includegraphics[scale=.75]{radulova-frames2}}


\end{frame}
\begin{frame}[t,fragile]\frametitle{Talking About Drugs}

\centerline{\includegraphics[scale=.75]{drugs}}
...
%
%\centerline{\includegraphics[scale=1]{policyagendas-drugs-hearings}}
...
%\centerline{\includegraphics[scale=.8]{negative_bar}}
%
%\slide{Campaigning with positive language}
%\centerline{\includegraphics[scale=.8]{positive_bar}}
%
%\slide{bin Laden, al Zawahiri, and `others'}
%
%\begin{center}
%\includegraphics[scale=.8]{binladen}
%\end{center}
%
...
~\\
\centerline{\includegraphics[scale=.9]{topics-ca}}
...
%\centerline{\includegraphics[scale=.8]{policyagendas-drugs-hearings}}
...
~\\
\centerline{\includegraphics[scale=.8]{district-party-focus}}
...
\centerline{\includegraphics[scale=.5]{indep-ref}}
...
(Sell high, buy low)
\newpage
\centerline{\includegraphics[scale=.7]{wickeroth-strategie-der-steine-3-2007}}
...
\centerline{\includegraphics[scale=.7]{lg-shrinkage}}


\end{frame}
\begin{frame}[t,fragile]\frametitle{In Action (Mikhaylov et al. 2012)}

\centerline{\includegraphics[scale=.9]{slava-rile3}}

\end{frame}
\begin{frame}[t,fragile]\frametitle{In Action (Mikhaylov et al. 2012)}

\centerline{\includegraphics[scale=.7]{slava-rile2}}

\end{frame}
\begin{frame}[t,fragile]\frametitle{In Action (Mikhaylov et al. 2012)}

\centerline{\includegraphics[scale=.6]{slava-rile}}


\newpage
\centerline{\includegraphics[scale=1]{confusionoftongues.png}}
...
\centerline{\includegraphics[scale=.7]{yk-measurement-error}}
...
\centerline{\includegraphics[scale=.8]{simex-proportion-hopkins-king}}
...
\centerline{\includegraphics[scale=.8]{new-topics-ca}}

(via pLSI) to

\centerline{\includegraphics[scale=.8]{lda-flat}}
...
\centerline{\includegraphics[scale=1]{dirichlet-alpha10}}

\end{frame}
\begin{frame}[t,fragile]\frametitle{$\alpha=.1$}

\centerline{\includegraphics[scale=1]{dirichlet-alpha-tenth}}
...
\centerline{\includegraphics[scale=.55]{topic-clustering}}

\end{frame}
\begin{frame}[t,fragile]\frametitle{and other schemes?}

\centerline{\includegraphics[scale=.5]{other-schemes}}
...
\centerline{\includegraphics[scale=.8]{nested-topics-nuclear}}
...
\centerline{\includegraphics[scale=.8]{blei-dynamic}}
...
\centerline{\includegraphics[scale=.5]{defence-topic-quinn}}
...
\centerline{\includegraphics[scale=.6]{stm-graphical-model}}
...
\centerline{\includegraphics[scale=.8]{stm-clerics}}

\end{frame}
\begin{frame}[t,fragile]\frametitle{Wrapping up}

\centerline{\includegraphics[scale=1.5]{compromise.png}}


\end{frame}
\begin{frame}[t,fragile]\frametitle{Lab Time}

\centerline{\includegraphics[scale=1]{hieroglyphic-keyboard-cm}}
...
\end{frame}
\begin{frame}[t,fragile]\frametitle{Regression Approaches}
...
\begin{center}
\includegraphics[scale=.6]{words-evans}
\end{center}
...
\begin{center}
\includegraphics[scale=.6]{topic-model}
\end{center}

\end{frame}
\begin{frame}[t,fragile]\frametitle{Legislative Debate}

\begin{center}
\includegraphics[scale=.5]{911}
\end{center}

\end{frame}
\begin{frame}[t,fragile]\frametitle{Legislative Vocabulary}
...
\end{frame}
\begin{frame}[t,fragile]\frametitle{Tomorrow}
