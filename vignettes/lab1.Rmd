...
One way to do this is to look for collocations.  
The collocation finder functions operates on the tokens of the corpus, 
so we extract them first
```{r}
...
Our first stem will be to create a document feature matrix (\texttt{dfm}), after 
